...
In order to bridge the gap between the long wave information obtained strictly through the time domain ($\etalong$) and the short wave information obtained through spatiotemporal analysis of waves directly resolved in-frame, we employed the extended wavelet directional method (EWDM) \cite{pelaez-zapata_ewdm_2025}. EWDM is a modern, actively-maintained framework for employing the wavelet directional method (WDM) of Donelan \etal., (1996) \cite{donelan_nonstationary_1996} as well as other wavelet-based wave directional estimation techniques \cite{krogstad_magnusson_donelan_2006,pelaez-zapata_ocean_2024}.
