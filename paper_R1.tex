...
\begin{document}
	...
	\add[Reviewer \#2]{The camera used for this work was a Pyxis Mono VIS from Polaris Sensor Technologies. The camera's detector is the Sony IMX250MZR "Polarsens"; in recent years, this has become the standard detector for polarimetric cameras used for sensing ocean waves} \cite{laxague_effects_2025}. \add[Reviewer \#2]{Per the manufacturer, the Sony IMX250 Pregius provides $>50$\% relative response between 400-800 nm light wavelengths. The spectral dependence of of this response was not determined as part of the present study, though such a quantity would be of import for techniques like PSSm} \cite{malinowski_surface_2024} \add[Reviewer \#2]{which depend on the wavelength dependence of DoLP.}
	...
	\begin{figure}[!ht]
		...
		\caption{Difference in mean wave direction $\theta_0$ computed between ADCP and E-PSS long waves\remove[Authors]{ (red), E-PSS short waves and "direct" (blue) spectra}.}
