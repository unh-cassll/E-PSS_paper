...
ax0.set_xlim(0, 10)
ax0.legend(loc='upper right', fontsize=fsize, ncol=2, columnspacing=1.0, handlelength=1.6)
...
ax1.set_xlim(0, 10)
ax1.set_ylim(-1.5, 1.5)   # headroom for the legend
ax1.set_xlabel('t [s]')
ax1.axvline(t_snap, color=color_list[3], lw=1.5, alpha=0.6)
ax1.legend(loc='lower right', fontsize=fsize, ncol=2, columnspacing=1.0, handlelength=1.6)
panel_tag(ax1, '(b)')
